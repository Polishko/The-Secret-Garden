    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand_name', models.CharField(help_text='Enter the brand name.', max_length=50, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='Brand Name')),
